...
const package = form.querySelector("#package > div");
...
const fourthItem = document.querySelector(
    ".calc__summary > ul > li + li + li + li"
);
const fifthItem = document.querySelector(
    ".calc__summary > ul > li + li + li + li + li"
);
